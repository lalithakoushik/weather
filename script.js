...
function changeBg(status) {
    if (status === 'Clouds') {
        document.body.style.backgroundImage = 'url(C:\Users\K LALITHA KOUSHIK\Desktop\Weather\images\clouds - Copy.jpg)';
    } else if (status === 'Rain') {
        document.body.style.backgroundImage = 'url(C:\Users\K LALITHA KOUSHIK\Desktop\Weather\images\rainy - Copy.jpg)';
    } else if (status === 'Clear') {
        document.body.style.backgroundImage = 'url(C:\Users\K LALITHA KOUSHIK\Desktop\Weather\images\clear.jpg)';
    }
    else if (status === 'Snow') {
        document.body.style.backgroundImage = 'url(C:\Users\K LALITHA KOUSHIK\Desktop\Weather\images\snow - Copy.jpg)';
    }
    else if (status === 'Sunny') {
        document.body.style.backgroundImage = 'url(C:\Users\K LALITHA KOUSHIK\Desktop\Weather\images\sunny - Copy.jpg)';
    } else if (status === 'Thunderstorm') {
        document.body.style.backgroundImage = 'url(C:\Users\K LALITHA KOUSHIK\Desktop\Weather\images\thunderstrom - Copy.jpg)';
    } else if (status === 'Drizzle') {
        document.body.style.backgroundImage = 'url(C:\Users\K LALITHA KOUSHIK\Desktop\Weather\images\drizzle - Copy.jpg)';
    } else if (status === 'Mist' || status === 'Haze' || status === 'Fog') {
        document.body.style.backgroundImage = 'url(C:\Users\K LALITHA KOUSHIK\Desktop\Weather\images\mist - Copy.jpg)';
    }

    else {
        document.body.style.backgroundImage = 'url(C:\Users\K LALITHA KOUSHIK\Desktop\Weather\images\bg.jpg)';
    }
}
